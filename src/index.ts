...
import { AzureOfflineKeyVaultPlugin } from "./plugins/offlineIdentity/azureOfflineKeyVaultPlugin"
...
export default class AzureIndex {
  public constructor(private serverless: Serverless, private options) {
    ...
    this.serverless.pluginManager.addPlugin(AzureOfflineKeyVaultPlugin);
  }
}
